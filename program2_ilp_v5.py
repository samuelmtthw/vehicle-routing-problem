...
# Note: FUEL_PRICE removed — each vehicle type now has its own pbbm field
...
OUTPUT_PATH  = os.path.join(os.path.dirname(__file__), "results_ilp_v5.csv")
...
def solve_scenario(scenario_id, depot, delivery_nodes):
    ...
    # c_ijl = (d_ij / e_l) × P_BBM_l  where P_BBM_l differs by fuel type
    cost_matrices = []
    for veh in VEHICLES:
...
def main():
    print("=" * 65)
    print("  HCVRP ILP Solver v5")
    print("  Method: Google OR-Tools CP Routing (PATH_CHEAPEST_ARC + GLS)")
