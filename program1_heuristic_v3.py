...
OUTPUT_PATH  = os.path.join(os.path.dirname(__file__), "results_heuristic_v3.csv")
...
def build_distance_matrix(nodes):
    ...
    Returns n×n matrix (km). Index 0 = depot.
    """
    n = len(nodes)
...
def main():
    print("=" * 65)
    print("  HCVRP Heuristic Solver v3")
