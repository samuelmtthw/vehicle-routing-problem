...
Create a virtual environment first, then install all dependencies inside it:

```bash
python3 -m venv .venv
source .venv/bin/activate
python3 -m pip3 install --upgrade pip3
python3 -m pip3 install pandas numpy scikit-learn requests ortools
```

If you see `externally-managed-environment` on macOS, it means the system Python is managed by Homebrew and should not be used for direct package installs. Activate the virtual environment above and rerun the install command. If you already have the environment activated, `python -m pip install ...` should work without `--break-system-packages`.
...
| --------- | ---------------- | -------------------------- | -------- |
| CLIENT_01 | Depot Balikpapan | Dec 26                     | 38       |
| CLIENT_01 | Depot Batam      | Dec 18, Dec 24             | 28–29    |
| CLIENT_01 | Depot Makassar   | Dec 19, Dec 23             | 26–63    |
| CLIENT_01 | Depot Manado     | Dec 18, Dec 24             | 17–32    |
| CLIENT_01 | Depot Medan      | Dec 23, Dec 24             | 25–83    |
| CLIENT_01 | Depot Pekanbaru  | Dec 8, 11, 18, 23, 24      | 21–44    |
| CLIENT_02 | Depot Jatiasih   | 27 days, Jul 2025–Jan 2026 | 28–46    |
